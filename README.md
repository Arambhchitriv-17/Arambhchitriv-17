...
* 🚀 **SFMC Expert:** Designing dynamic cross-channel journeys using AMPscript and SQL.
* 📊 **Data-Driven:** Translating campaign metrics into interactive Power BI / Tableau dashboards.
* ⚙️ **Automation Mindset:** Streamlining workflows from audience discovery to deployment.
...
#### 🔷 Ceptra Infotech Pvt. Ltd. | **Campaign Manager & SFMC Developer Intern**
*📅 Aug 2025 – Present | 📍 Nagpur*
* **Omni-Channel Execution:** Crafted transactional Email + SMS flows for banking (Onboarding, EMI tracking).
* **Dynamic Scale:** Written AMPscript for personalized financial statements and localized content blocks.
* **Data Pipelines:** Designed scheduled automation sequences via SQL segments and Automation Studio.
* **Analytics:** Built unified executive engagement trackers utilizing Power BI.

#### 🔷 Tars Technologies | **Data Analyst Intern**
*📅 Jan 2025 – Jul 2025 | 📍 Nagpur*
* **BI Architecture:** Programmed enterprise-facing dashboards using Power BI and custom DAX measures.
* **Data Preparation:** Engineered Python and SQL cleaning logic pipelines for messy, complex client telemetry.

---

## 🌟 Featured Projects

### 🏦 01. Banking Customer Lifecycle Engine
> **Tech:** SFMC (Journey Builder, Automation Studio), SQL, AMPscript, Power BI

* **The Build:** End-to-end multi-channel infrastructure managing account setup, risk validation, and retention signals.
* **Execution Strategy:** `[SQL Audience Segments]` ➔ `[Journey Builder Splits]` ➔ `[AMPscript Dynamic Offers]` ➔ `[Power BI Campaign KPIs]`

<details>
<summary><b>🔍 View Campaign Scope & Key Metrics Tracked</b></summary>

| Campaign Scope | Target Metrics |
| :--- | :--- |
| • Onboarding & Credit Card Activation<br>• Real-time EMI Due Reminders<br>• Dormancy Re-engagement (60+ days) | • Email Open / Click-Through Rates (CTR)<br>• Month-1 Card Activation Velocity<br>• Net Customer Retention Impact |

</details>

### 🏥 02. Healthcare Patient Engagement Pipeline
> **Tech:** SFMC (Mobile Studio, Email Studio), Automation Studio, SQL, HTML
